  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 right-1/4 w-12 h-16 bg-gradient-to-r from-gray-350 to-gray-450 transform -rotate-6 opacity-30"></div>
        ...
        <div className="absolute top-2/3 left-0 w-full h-6 bg-gradient-to-r from-gray-450 to-gray-550 transform rotate-6 opacity-50"></div>
